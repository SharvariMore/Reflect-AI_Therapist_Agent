...
export default function OceanWaves() {
  ...
  return (
    <div className="flex h-[400px] flex-col items-center justify-center space-y-8">
      <div className="relative h-48 w-48">
        <div className="absolute inset-0 rounded-full bg-gradient-to-b from-blue-500/20 to-transparent blur-xl" />
        <motion.div
          animate={waveControls}
          className="absolute inset-0 flex items-center justify-center"
        >
          <div className="relative">
            <Waves className="h-24 w-24 text-blue-600" />
            <motion.div
              animate={{
                opacity: [0.5, 0.8, 0.5],
              }}
