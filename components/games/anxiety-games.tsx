...
import { Gamepad2, Flower2, Wind, TreePine, Waves, Music2, Flower, TreeDeciduous, TreePalm, Clock } from "lucide-react";
import {
  Card,
  CardContent,
  CardDescription,
...
{/* Log game activity to the database */}
...
export const AnxietyGames = ({ onGamePlayed }: AnxietyGamesProps) => {
  const [selectedGame, setSelectedGame] = useState<string | null>(null); {/* selectedGame - track the currently selected game */}
  const [showGame, setShowGame] = useState(false); {/* showGame - track which game should be currently visible */}
